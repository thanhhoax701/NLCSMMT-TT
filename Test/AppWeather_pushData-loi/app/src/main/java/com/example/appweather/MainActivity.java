...
//    final String WEATHER_URL = "https://api.openweathermap.org/data/2.5/onecall?";
    ...
    EditText edtDemo, edtSearch;
    Button btn, btnChangeActivity, btnAddTimeWeather, btnAddCurrentWeather, btnHistoryWeather;
...
//                getData();
    ...
    private void pushData() {
        ...
        DatabaseReference myRef1 = database1.getReference("weatherHistory");
        myRef1.setValue("Xin chào");
    }
