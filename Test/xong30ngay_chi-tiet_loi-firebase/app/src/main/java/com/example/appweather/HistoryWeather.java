...
//        btnThemNgay30.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                currentWeather6(cityName);
//                btnThemNgay30.setVisibility(View.GONE);
//            }
//        });
    }
...
//                            historyWeather30(lat, lon, day30, day28);
    ...
    public void currentWeather6(String data) {
        // Thực thi những request mà mình gửi đi
        // Cú pháp Request của thư viện Volley
        RequestQueue requestQueue = Volley.newRequestQueue(HistoryWeather.this);
        String url = "https://api.openweathermap.org/data/2.5/weather?q=" + data + "&units=metric&lang=vi&appid=7b16a3bb0d4c6253ab56ca6a2a14f500";
...
////                            historyWeather(latO, lonO, day7, today);
////                            historyWeather(latO, lonO, day14, day7);
////                            historyWeather(latO, lonO, day21, day14);
////                            historyWeather(latO, lonO, day28, day21);
////                            historyWeather(latO, lonO, day30, day28);
//
////                            historyWeather7(latO, lonO, day7, today);
////                            historyWeather14(latO, lonO, day14, day7);
////                            historyWeather21(latO, lonO, day21, day14);
////                            historyWeather28(latO, lonO, day28, day21);
////                            historyWeather30(latO, lonO, day30, day28);
//
////                            historyWeather7(latO, lonO, day30, day28);
////                            historyWeather14(latO, lonO, day28, day21);
////                            historyWeather21(latO, lonO, day21, day14);
////                            historyWeather28(latO, lonO, day14, day7);
////                            historyWeather30(latO, lonO, day7, today);
////                            historyList.clear();
//
//                        } catch (JSONException e) {
//                            e.printStackTrace();
...
//    }
    ...
    public void historyWeather30(String latB, String lonB, long start, long end) {
        RequestQueue requestQueue = Volley.newRequestQueue(HistoryWeather.this);
        String url30 = "http://history.openweathermap.org/data/2.5/history/city?lat=" + latB + "&lon=" + lonB + "&type=hour&units=metric&lang=vi&appid=7b16a3bb0d4c6253ab56ca6a2a14f500&start=" + start + "&end=" + end;
...
//                            historyList.clear();
    ...
    public void historyWeather28(String latB, String lonB, long start, long end) {
        RequestQueue requestQueue = Volley.newRequestQueue(HistoryWeather.this);
        String url28 = "http://history.openweathermap.org/data/2.5/history/city?lat=" + latB + "&lon=" + lonB + "&type=hour&units=metric&lang=vi&appid=7b16a3bb0d4c6253ab56ca6a2a14f500&start=" + start + "&end=" + end;
        Log.d("urlHistory2", url28);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url28,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("14", response);
...
//                            // Cập nhật khi có dữ liệu mới
    ...
    public void historyWeather21(String latB, String lonB, long start, long end) {
        RequestQueue requestQueue = Volley.newRequestQueue(HistoryWeather.this);
        String url21 = "http://history.openweathermap.org/data/2.5/history/city?lat=" + latB + "&lon=" + lonB + "&type=hour&units=metric&lang=vi&appid=7b16a3bb0d4c6253ab56ca6a2a14f500&start=" + start + "&end=" + end;
        Log.d("urlHistory3", url21);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url21,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("21", response);
...
//                            historyList.clear();
    ...
    public void historyWeather14(String latB, String lonB, long start, long end) {
        RequestQueue requestQueue = Volley.newRequestQueue(HistoryWeather.this);
        String url14 = "http://history.openweathermap.org/data/2.5/history/city?lat=" + latB + "&lon=" + lonB + "&type=hour&units=metric&lang=vi&appid=7b16a3bb0d4c6253ab56ca6a2a14f500&start=" + start + "&end=" + end;
        Log.d("urlHistory4", url14);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url14,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("28", response);
