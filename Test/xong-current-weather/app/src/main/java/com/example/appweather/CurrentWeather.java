...
//        Log.d("url", url);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String luongMuaCW = jsonObjectCurrent.getString("rain");
                            txtLuongMuaCW.setText(luongMuaCW + "mm");

                            String tuyetCW = jsonObjectCurrent.getString("snow");
    ...
    public void Anhxa () {
        ...
        iconCW = (ImageView) findViewById(R.id.iconCW);
